export const presets = ['default', 'regularAlt']
...
export const styleSheetMd = {
    default: `@def color_header @web_color_bg;
...
.for-google-icon-background {
    google_icon_background_color: @web_color_secondary_key_bg;
}
.for-google-icon-foreground {
    color: @web_color_label;
}
...
export const styleSheetMdBorder = {
    default: `;.keytop {
    elevation: 0;
...
.keytop.for-action-key:pressed {
    background_color: @web_color_secondary_key_bg_pressed;
    shadow_color: @web_color_secondary_key_bg_pressed;
    elevation: 0;
}
.keytop.for-action-key {
    background_color: @web_color_secondary_key_bg;
